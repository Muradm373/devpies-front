...
import { getListOfHospitalsByPage, resetListOfHospitals } from "../../actions/RepresentativeActions";
import {
  Card,
  Button,
  CardBody,
...
class HospitalsManagement extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLazyLoading: false,
  ...
  cancelEdit() {
    this.setState({ selectedHospital: undefined });
  }
  cancelRegistration() {
        ...
        <div className=" text-center mt-1">
          <div className="text-left content mx-auto">
            ...
            <p className="description text-center w-75 mx-auto mt-0">
              Here you will be able to edit hospitals list.
            </p>
            <Row>
              <Col md="12">
                  ...
                  <BottomScrollListener onBottom={this.lazyLoad}>
                              ...
                              {this.props.listOfAdminHospitals.map((x) => (
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    {`${this.parseTime(x.openTime)}-${this.parseTime(x.closeTime)}`}
                                    </span>
                                    <br></br>
                    ...
                    >
                      <Fab
                        ...
                        aria-label="edit"
                      >
                        <i className="fas fa-hospital fa-1x mr-3" />
                        Add hospital
                      </Fab>
                    </div>
                  </CardBody>
...
export default connect(mapStateToProps, mapDispatchToProps)(HospitalsManagement);