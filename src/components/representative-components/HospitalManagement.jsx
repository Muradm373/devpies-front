...
import {getHospitalById, editHospitalById} from "../../actions/RepresentativeActions";
...
class RepresentativeManagement extends Component {
  constructor(props) {
    ...
    this.props.getHospitalById(this.props.selectedHospital.id);
  }


  componentWillReceiveProps(props){
    this.setState({
        closeTime: props.fetchedHospital.closeTime,
        name: props.fetchedHospital.name,
        openTime: props.fetchedHospital.openTime,
        address:props.fetchedHospital.address,
        city: props.fetchedHospital.city,
        country: props.fetchedHospital.country,
        postalCode: props.fetchedHospital.postalCode,
        phoneNumber: props.fetchedHospital.phoneNumber,
        lat: props.fetchedHospital.lat,
        lng: props.fetchedHospital.lng,
        website: props.fetchedHospital.website,
        representative: props.fetchedHospital.representative
    })
  }

  saveHospital(){
      let HospitalNew = JSON.stringify({
      ...
      this.props.editHospitalById(this.props.fetchedHospital.id, HospitalNew)
  }
  render() {
    return (
      <div>
        <div className=" text-center mt-1">
          <div className="text-left content mx-auto">
            ...
            <p className="description text-center w-75 mx-auto mt-0">
              Here you will be able to edit Hospital list.
            </p>
            <Row>
              <Col md="5">
...
const mapDispatchToProps = (dispatch) => {
  return {
    getHospitalById: (id)=>{
        getHospitalById(dispatch, id)
    },
    editHospitalById: (id, Hospital)=>{
        editHospitalById(dispatch, id, Hospital)
    }
  };
};
